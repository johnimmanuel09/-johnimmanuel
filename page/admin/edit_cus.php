...
include"../../db.php";
$id = $_GET['id'];
$e_qry_cus = mysqli_query($mysql, "SELECT * from customer where id_cus='$id'");
$e_cus = mysqli_fetch_array($e_qry_cus);
?>
...
if($simpan)
{
	...
	$kd = $_POST['id_cus'];
	mysqli_query($mysql, "UPDATE customer set nama_cus='$cos',email_cus='$ecos',password_cus='$pcos' where id_cus='$kd'");
