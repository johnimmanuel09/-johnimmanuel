...
//        koneksi ke database
       $koneksi = mysqli_connect('localhost', 'root', '');
        $db = mysqli_select_db($mysql, 'abdul_ukk');
...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header" style="text-align:center;background:#4CAF50;color:#fff;color:#fff;">
          ...
          <form action="tambah_buku.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                <div class="form-group">
                    ...
                    <select class="form-control" name="kategori">
                        <?php
                            $q_allkat = mysqli_query($mysql, "SELECT * from kategori"); 
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="katalog">
                        <?php
                            $q_allkatalog = mysqli_query($mysql, "SELECT * from katalog"); 
                            while($katalog = mysqli_fetch_array($q_allkatalog)){
                        ?>
