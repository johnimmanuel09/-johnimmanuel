...
include"../../db.php";
session_start();
$qrybuku = mysqli_query($mysql,"SELECT * from buku");
@$act = $_GET['act'];
if($act=="tambah"){
...
<div id="menu">
	<div class="menukiri">
		<b style="padding:20px;line-height:70px;font-size:20px;color:#fff;">Aplikasi Toko Buku online (PROPOSTOKOON.COM)</b>
	</div>
	<div class="menukanan">
	<ul>
