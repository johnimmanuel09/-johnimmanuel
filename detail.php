...
include"db.php";
$kd = $_GET['id'];
$q_detail = mysqli_query($mysql, "SELECT * from buku where id_buku='$kd'");
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header" style="text-align:center;background:#32CD32;color:#fff;">
		...
		<div class="modal-footer">
			...
			<!-- <form action="login.php" method="post"> -->
				<button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#login">Login</button>
            ...
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <form action="actlogin.php" method="post">
                              ...
                              belum punya akun? <br><a data-toggle="modal" data-target="#daftar">Daftar</a>
                        </div>
                  </form>
            </div>
      </div>
